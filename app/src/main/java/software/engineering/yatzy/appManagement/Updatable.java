...
public interface Updatable {
     ...
     * @param gameID           Optional. Corresponds to application protocol index 1. To specify which game has been updated. -1 if not used
    ...
    void update(int protocolIndex, int gameID, String exceptionMessage);
}
